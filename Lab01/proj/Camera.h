...
public:
	...
	{
		float offset_angle = xoffset;
		Position.x = Position.x * cos(offset_angle) + Position.z * sin(offset_angle);
		Position.z = Position.z * cos(offset_angle) - Position.x * sin(offset_angle);
	}
